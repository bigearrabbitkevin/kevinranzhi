				...
				<?php if($groupUsers):?>
					<tr>
						...
						<td id='group' class='form-control ' size='10' style='height:200px;overflow:auto;' ><?php $i = 1;?>
							<div class='w-80px' >
								<strong><?php echo '部门内成员';;?></strong><?php echo html::selectAll('indept', 'checkbox', true);?>
							</div>
							...
							<br>
							<div class='w-80px ' >
								<strong><?php echo '部门外成员';?></strong><?php echo html::selectAll('extdept', 'checkbox', true);?>
							</div>
							<?php foreach($groupUsers as $account => $realname):
				...
				<tr>
					...
					<td id='other' class='form-control' size='10' style='height:200px;overflow:auto;'>
						...
						<?php foreach($groupNotInUsers as $account => $realname):?>
							<div class='group-item' id='otherdept'><?php echo html::checkbox('members', array($account => $realname), '');?></div>
